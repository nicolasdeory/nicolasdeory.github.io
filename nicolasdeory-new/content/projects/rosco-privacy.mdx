...
Para ayudar a explicar las cosas de la manera más clara posible en esta Política de privacidad, cada vez que se hace referencia a cualquiera de estos términos, se definen estrictamente como:
  ...
  -Compañía: cuando esta política menciona "Compañía", "nosotros", "nos" o "nuestro", se refiere a El Rosco, que es responsable de su información en virtud de esta Política de privacidad.
  -Plataforma: sitio web de Internet, aplicación web o aplicación digital de cara al público de El Rosco.
  -País: donde se encuentra El Rosco o los propietarios / fundadores de El Rosco, en este caso es España
  -Cliente: se refiere a la empresa, organización o persona que se registra para utilizar el Servicio El Rosco para gestionar las relaciones con sus consumidores o usuarios del servicio.
  -Dispositivo: cualquier dispositivo conectado a Internet, como un teléfono, tablet, computadora o cualquier otro dispositivo que se pueda usar para visitar El Rosco y usar los servicios.
  ...
  -Personal: se refiere a aquellas personas que son empleadas por El Rosco o están bajo contrato para realizar un servicio en nombre de una de las partes.
  ...
  -Servicio: se refiere al servicio brindado por El Rosco como se describe en los términos relativos (si están disponibles) y en esta plataforma.
  ...
  -Sitio web: el sitio de El Rosco, al que se puede acceder a través de esta URL: 
  -Usted: una persona o entidad que está registrada con El Rosco para utilizar los Servicios.
...
Usted reconoce y acepta que El Rosco no será responsable de ningún Servicio de terceros, incluida su precisión, integridad, puntualidad, validez, cumplimiento de los derechos de autor, legalidad, decencia, calidad o cualquier otro aspecto de los mismos. El Rosco no asume ni tendrá ninguna obligación o responsabilidad ante usted o cualquier otra persona o entidad por los Servicios de terceros.
