...
The project is written in C#, leveraging .NET Core for a small memory footprint and fast performance.
...
The UI is written in HTML/CSS/Javascript, running inside .NET Core via [Chromely](https://github.com/chromelyapps/Chromely):
