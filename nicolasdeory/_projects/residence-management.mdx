...
The idea for this project was take into account the specific needs of this residence network, while also
...
For example, this is part of the code for a confirmation modal –
